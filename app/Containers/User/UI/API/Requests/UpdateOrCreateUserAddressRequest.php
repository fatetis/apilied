...
/**
 * Class UpdateOrCreateUserAddressRequest.
 */
class UpdateOrCreateUserAddressRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'area_code' => 'required|exists:regions,region_code,deleted_at,NULL',
            'address' => 'required',
            'default' => 'boolean',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'area_code.required' => '收货人省市区不能为空',
            'area_code.exists' => '收货人省市区数据不合法',
